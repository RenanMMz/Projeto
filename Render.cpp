	...
	bool InitD3D(HWND hWnd)
	{
		...
		D3D11_BUFFER_DESC bdVertex = {}; bdVertex.Usage = D3D11_USAGE_DEFAULT; bdVertex.ByteWidth = sizeof(Vertex) * 6; bdVertex.BindFlags = D3D11_BIND_VERTEX_BUFFER; hr = device->CreateBuffer(&bdVertex, nullptr, &vertexBuffer);
	...
	void RenderGameplay()
	{
		...
		if (paddleVisible)
		{
			deviceContext->PSSetShader(pixelShaderPaddle, nullptr, 0); deviceContext->IASetVertexBuffers(0, 1, &paddleVertexBuffer, &stride, &offset); deviceContext->Draw(6, 0);
		}
